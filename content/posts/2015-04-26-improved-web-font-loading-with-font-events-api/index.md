...
summary: "Improve web font loading with FontFaceObserver and the Font Loading API to reduce FOIT and make text rendering more predictable."
categories:
  - programming
tags:
  - webfonts
...
![Before: Web font loading with FOIT](filmstrip-old.png)
...
![After: Improved web font loading without FOIT](filmstrip-new.png)
